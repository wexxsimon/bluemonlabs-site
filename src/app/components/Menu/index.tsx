...
export default function Menu (): ReactElement {
  return (
    <header className="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm py-0 dark:bg-gray-800 absolute px-6 md:px-12 xl:px-36">
      <nav
        className="max-w-[85rem] w-full h-[78px] md:h-[86px] mx-auto border-b-1 border-persian-blue-900"
        aria-label="Global"
      >
        <div className="relative w-full h-[78px] md:h-[86px] mt-5 md:mt-0 md:flex md:items-center md:justify-between self-center">
          <div className="flex items-center justify-between">
            ...
            <div className="md:hidden">
              <button
                type="button"
                className="hs-collapse-toggle flex justify-center items-center w-9 h-9 text-sm font-semibold rounded-lg border border-gray-200 text-white-100 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
          ...
          >
            <div className="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500">
              <div className="flex flex-col gap-x-0 mt-5 divide-y divide-dashed divide-gray-200 md:flex-row md:items-center md:justify-end md:gap-x-7 md:mt-0 md:ps-7 md:divide-y-0 md:divide-solid dark:divide-gray-700">
                <a
                  className="font-acumin-300 text-xs text-white-100 py-3 md:py-6 hover:text-persian-blue-300 hover:animate-pulse"
                  href="#"
                  aria-current="page"
                >
                  Home
                ...
                <a
                  className="font-acumin-300 text-xs text-white-100 hover:text-persian-blue-300 hover:animate-pulse py-3 md:py-6 dark:text-white-100 dark:hover:text-white-100 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="#"
                >
                  Contato
                </a>
                ...
                <div className="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none] md:[--trigger:hover] py-3 md:py-4">
                  <button
                    type="button"
                    className="flex items-center w-full font-acumin-300 text-xs text-white-100 hover:text-persian-blue-300 hover:animate-pulse font-medium "
                  >
                    Serviços
                    <svg
                  ...
                  <div className="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-10 top-full start-0 min-w-[15rem] bg-transparent-full md:shadow-2xl rounded-lg py-2 md:p-4 dark:bg-gray-800 dark:divide-gray-700 before:absolute before:-top-5 before:start-0 before:w-full before:h-5">
                    <div className="md:grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div className="flex flex-col mx-1 md:mx-0">
                        <a
                          className="group flex gap-x-5 hover:bg-gray-100 rounded-lg p-4 dark:text-white-100 dark:hover:bg-gray-900 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                          href="#"
                        >
                          <svg
                          ...
                          <div className="grow">
                            ...
                            <p className="text-sm text-white-100 group-hover:text-white-100 dark:group-hover:text-white-100">
                      ...
                      <div className="flex flex-col pt-4 md:pt-0 mx-1 md:mx-0">
                        <span className="text-sm font-semibold uppercase text-white-100 dark:text-white-100">
                          Customer stories
                        </span>
                        ...
                        >
                          ...
                          />
                          <div className="grow">
                            <p className="text-sm text-white-100 dark:text-slate-400">
                              Preline Projects has proved to be most efficient
                              cloud based project tracking and bug tracking
                              tool.
                            </p>
                            <p className="mt-3 inline-flex items-center gap-x-1 text-sm text-white-100 decoration-2 hover:underline font-medium dark:text-white-100 dark:hover:text-white-100 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-slate-600">
                              Learn more
                              <svg
                ...
                <div className="pt-3 md:pt-0">
                  <a
                    className="py-1 px-4 inline-flex items-center gap-x-2 font-acumin-300 text-xs font-semibold rounded-full border border-transparent bg-white-100 text-persian-blue-900 hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="#"
                  >
                    <Image
